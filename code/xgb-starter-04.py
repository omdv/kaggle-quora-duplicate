...
if __name__ == '__main__':
    ...
    x_train_full = pd.concat((X_train, X_train_ab, train_leaky), axis=1)
    y_train = df_train['is_duplicate'].values
    del x_train_full['question1']
    del x_train_full['question2']
    ...
    x_test_full = pd.concat((X_test, x_test_ab, test_leaky), axis=1)
    ...
    # sub.to_csv('../output/starter-03-177002.csv',index=False)