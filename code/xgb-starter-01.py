...
def word_shares(row):
	q1_list = str(row['question1'])
	q1_list = q1_list.lower().split()
	q1 = set(q1_list)
	q1words = q1.difference(stops)
	if len(q1words) == 0:
		return '0:0:0:0:0:0:0:0:0'
    
	q2_list = str(row['question2'])
	q2_list = q2_list.lower().split()
	q2 = set(q2_list)
	...
	q1_3gram = set([i for i in zip(q1_list, q1_list[1:], q1_list[2:])])
	q2_3gram = set([i for i in zip(q2_list, q2_list[1:], q2_list[2:])])
	...
	return '{}:{}:{}:{}:{}:{}:{}:{}:{}'.format(R1, R2, len(shared_words), R31, R32, R2gram, Rcosine, words_hamming, R3gram)
...
x['shared_3gram']     = df['word_shares'].apply(lambda x: float(x.split(':')[8]))
